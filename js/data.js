...
const DATA = {
  ...
  initials:      "BAG",
  profilePhoto:  "assets/Profile.jpg",   // set to "" to show initials instead
  brandName:     "Bharath",
  role:          "Data Engineer",
  ...
  experience: [
    {
      ...
      bullets: [
        `Designed <strong>ADF & Databricks</strong> ingestion pipelines to unify multi-source data for downstream analytics.`,
        `<strong>PySpark</strong> transformations improved data quality by <strong>25%</strong> and reduced duplicates by <strong>40%</strong>.`,
        `Optimized star schema models cut query performance by <strong>35%</strong> and report time by <strong>20%</strong>.`,
        `Delivered <strong>Power BI</strong> dashboards accelerating executive decisions across logistics operations.`,
      ],
    ...
    },
    {
      ...
      bullets: [
        `Built a <strong>Python & REST API</strong> automation framework that drastically reduced manual migration effort.`,
        `Migrated pipelines, notebooks, and Spark configs with full business logic consistency across platforms.`,
        `Secured credentials via <strong>Azure Key Vault</strong> for seamless storage and SQL integration.`,
        `Validated Fabric pipelines achieving <strong>30% performance improvement</strong> on large-scale ADLS-to-SQL movement.`,
      ],
    ...
    },
    {
      ...
      bullets: [
        `Cleaned and engineered features from <strong>15,000+ YouTube records</strong> for predictive ML modeling.`,
        `Applied <strong>Support Vector Regression</strong>, boosting prediction accuracy by <strong>54%</strong>.`,
        `Automated end-to-end ML workflow across four regression models, cutting manual effort by <strong>70%</strong>.`,
      ],
